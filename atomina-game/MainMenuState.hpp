...
public:
    ...
    MainMenuState(std::shared_ptr<ATMA::AppWindow> win): BaseState() 
    {
        ...
        m_menuObjs[0] = ctx.getAttribute<ATMA::AttrRenderable>(m_menuOpts[0], ATMA::AttributeType(ATMA::Attribute::Render));
        ...
        m_menuObjs[1] = ctx.getAttribute<ATMA::AttrRenderable>(m_menuOpts[1], ATMA::AttributeType(ATMA::Attribute::Render));
        ...
        m_menuObjs[2] = ctx.getAttribute<ATMA::AttrRenderable>(m_menuOpts[2], ATMA::AttributeType(ATMA::Attribute::Render));
