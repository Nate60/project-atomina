...
namespace ATMA
{
    ...
    public:
         ...
         */
        virtual void activate(ATMAContext *l_ctx);

        /**
         * function called by context when deactivating state
         */
        virtual void deactivate(ATMAContext *l_ctx);
         ...
         */
        virtual void handleInput(ATMAContext *l_ctx, const WindowEvent &l_winEvent) = 0;
