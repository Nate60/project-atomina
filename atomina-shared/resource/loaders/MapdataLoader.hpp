...
namespace ATMA
{
    ...
    template<>
    class ResourceLoader<Mapdata>
    {
    public:
        ResourceLoader();
        virtual ~ResourceLoader();
        /**
         * factory function for creating Mapdata resource
        ...
        std::shared_ptr<Mapdata> load(ATMAContext *l_ctx, const std::string &l_name);
    };
}
