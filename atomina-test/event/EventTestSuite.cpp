...
TEST_F(EventFixture, EventModifiesAttribute)
{
    ...
    this->ctx.registerAttributeType<ATMA::AttrTranslatable>(ATMA::AttrType(ATMA::Attribute::Translatable));
    ...
    auto clbck = [&](ATMA::EventContext&)->void{
        ...
        auto attr = ctx.getAttribute<ATMA::AttrTranslatable>(obj, ATMA::AttrType(ATMA::Attribute::Translatable));
        attr->m_x = 100;
    };
    this->ctx.addCallback(0u, 0u, clbck);
    this->ctx.addEvent(0u, 0u, ATMA::EventContext{});
    this->ctx.update();
    auto outerAttr = ctx.getAttribute<ATMA::AttrTranslatable>(obj, ATMA::AttrType(ATMA::Attribute::Translatable));
